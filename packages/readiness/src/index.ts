...
export const PRODUCTION_BLOCKING_CHECKS = [
  ...
  'CUSTOM_DOMAIN_NOT_ACTIVE', 'SIGN_SERVICE_NOT_CONFIGURED',
  'VALIDATION_SERVICE_NOT_CONFIGURED', 'RETENTION_POLICY_NOT_APPROVED',
  'DPA_NOT_ACCEPTED', 'ACCEPTANCE_TEST_NOT_PASSED', 'SOFTWARE_TEST_KEY_IN_PRODUCTION',
  'CERTIFICATE_EXPIRED',
] as const;
