...
function safeKnown(cause: unknown): AuthRequestError {
  ...
  const mapping: Readonly<Record<string, readonly [number,string]>> = {
    ...
    IDEMPOTENCY_CONFLICT: [409,'Samma begärande-ID har redan använts med andra kontouppgifter.'],
    ...
    ORGANIZATION_PROVISIONING_NOT_COMPLETED: [409,'Organisationen är inte färdigskapad ännu. Vänta tills provisioneringen är klar och försök igen.'],
    ORGANIZATION_DATA_ENVIRONMENT_NOT_READY: [409,'Organisationens datamiljö är inte färdig för konton ännu. Kör om organisationsskapandet och försök igen.'],
    ORGANIZATION_ROLE_NOT_PROVISIONED: [409,'Den valda rollen är inte tillgänglig för organisationen.'],
    AUTH_PROVIDER_REJECTED: [502,'Identitetstjänsten avvisade inbjudan. Kontrollera Supabase Auth- och SMTP-inställningarna.'],
    AUTH_PROVIDER_VALIDATION_FAILED: [422,'Identitetstjänsten avvisade uppgifterna i inbjudan.'],
    AUTH_PROVIDER_FAILURE: [503,'Identitetstjänsten kunde inte slutföra inbjudan. Försök igen.'],
    AUTH_PROVIDER_RESPONSE_INVALID: [502,'Identitetstjänsten returnerade ett ogiltigt svar.'],
    AUTH_PROVIDER_USER_LOOKUP_LIMIT: [503,'Identitetstjänstens användarsökning kunde inte slutföras.'],
    AUTH_PROVIDER_IDENTITY_MISMATCH: [502,'Identitetstjänsten returnerade fel användaridentitet.'],
    SUPABASE_AUTH_SERVICE_ROLE_KEY_MISSING: [503,'API-tjänsten saknar servernyckeln för Supabase Auth.'],
    ORGANIZATION_ACCOUNT_INVITATION_CREATE_FAILED: [503,'Inbjudningsposten kunde inte sparas. Försök igen.'],
    ORGANIZATION_ACCOUNT_PROVISION_FAILED: [503,'Kontot kunde inte kopplas till organisationen. Försök igen.'],
    ORGANIZATION_USER_CREATE_FAILED: [503,'Organisationsanvändaren kunde inte skapas. Försök igen.'],
    ORGANIZATION_MEMBERSHIP_CREATE_FAILED: [503,'Användarens organisationsmedlemskap kunde inte skapas. Försök igen.'],
