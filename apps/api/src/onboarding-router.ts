...
function known(cause: unknown): OnboardingRequestError {
  ...
  const map: Readonly<Record<string, readonly [number,string]>> = {
    ...
    INVALID_APPLICATION_STATE_TRANSITION:[409,'INVALID_APPLICATION_STATE_TRANSITION'], APPLICATION_ALREADY_CLOSED:[409,'APPLICATION_ALREADY_CLOSED'],
    INVALID_PROVISIONING_STATE:[409,'INVALID_PROVISIONING_STATE'], DEPLOYMENT_PROFILE_MISSING:[409,'DEPLOYMENT_PROFILE_MISSING'],
